 ...
 * @FileName : GiftCardMaster.java
 * @since    : 2022. 01. 05.
 * @author   : jhbaek@kyobobook.com
 * @implNote : 기프트카드 마스터 Domain
 */
@Data
@SuperBuilder
...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(description = "기프트카드 마스터 도메인")
public class GiftCardMaster {
    ...
    public String pros_succsYsno; 
    
    @ApiModelProperty(value = "결제실패사유코드", required=false, example = "")
    public String stlmFlrRsnCode;
    
    @ApiModelProperty(value = "결제메시지내용", required=false, example = "success")
    public String stlmMsgCntt;
