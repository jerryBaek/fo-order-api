...
public class Cart {
    ...
    /** 장바구니ID */
    @ApiModelProperty(required = true, value = "장바구니ID", example = "")
    private String spbkId;
    /** 장바구니구분코드 */
    @ApiModelProperty(required = true, value = "장바구니구분코드", example = "")
    private String spbkDvsnCode;
    /** 장바구니종류코드 */
    @ApiModelProperty(required = true, value = "장바구니종류코드", example = "")
    ...
    /** 종료일시 */
    @ApiModelProperty(required = true, value = "종료일시", example = "")
    private LocalDateTime endDttm;
    /** 회원여부 */
    @ApiModelProperty(required = true, value = "회원여부", example = "")
    private String mmbrYsno;
    /** 사은품여부 */
    @ApiModelProperty(required = true, value = "사은품여부", example = "")
    private String frbeYsno;
    /** 본판매상품id */
    @ApiModelProperty(required = true, value = "본판매상품id", example = "")
    ...
    /** 체크여부 */
    @ApiModelProperty(required = true, value = "체크여부", example = "")
